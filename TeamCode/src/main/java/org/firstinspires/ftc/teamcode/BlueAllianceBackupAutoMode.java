...
/*
TODO: drive to shoot into thte high goal and drop the wobble goal in the respective area and then park on
 */
@Autonomous(name="BlueAlliance Backup Auto")
public class BlueAllianceBackupAutoMode extends LinearOpMode {
    // Data field.
    ...
    public void runOpMode() {
        ...
        shooterPowerSettingHigh     = 0.65;
        shooterPowerSettingLow      = 0.65;
        transferOnSetting           = 1;
     ...
     */
        ...
        Trajectory trajectory2 = drive.trajectoryBuilder(trajectory1.end())
                ...
                .splineTo(new Vector2d(23, 33), Math.toRadians(0))
        ...
        sleep(750);
        Trajectory trajectory2_1 = drive.trajectoryBuilder(trajectory2.end())
                .splineToConstantHeading(new Vector2d(10,33),Math.toRadians(0))
                .build();
        drive.followTrajectory(trajectory2_1);
